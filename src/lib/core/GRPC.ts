...
import { GrpcEventsClient } from './grpcHandlers/EventsClient';
import { GrpcLevelsClient } from './grpcHandlers/LevelsClient';

export class GRPC {
  private readonly credidentials = credentials.createInsecure();
  public economy: GrpcEconomyClient;
  public shop: GrpcShopClient;
  public timedEvents: GrpcEventsClient;
  public levels: GrpcLevelsClient;
  ...
  constructor() {
    ...
    this.timedEvents = new GrpcEventsClient('127.0.0.1:3000', this.credidentials);
    this.levels = new GrpcLevelsClient('127.0.0.1:3000', this.credidentials);
  }
}
